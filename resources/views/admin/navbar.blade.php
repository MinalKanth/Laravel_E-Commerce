    ...
    <!-- partial:partials/_navbar.html -->
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          ...
          <div class="navbar  align-items-center justify-content-center">
              <a class="navbar-brand brand-logo-mini" href="{{ url('/') }}"><img width="70px" src="home/images/ViPrak.jpeg" alt="#" /></a>
              <h1 class="title" style="color:aliceblue">ViPrak ( E-Commerce ) Admin Pannel</h1>
        </div>
